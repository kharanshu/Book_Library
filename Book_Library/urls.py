...
urlpatterns = [
    ...
    path('hard-delete-book/<int:pk>/',views.hard_delete_book),
    path('restore/<int:id>/',views.restore_data),
    path('restore-all/',views.restore_all_data),
    path('soft-delete-all/',views.soft_delete_all)
]
